...
module tb;
  ...
  kmac_app_intf kmac_app_if[kmac_app_agent_pkg::NUM_APP_INTF](.clk(clk), .rst_n(rst_n));
  ...
  kmac #(
    ...
    .NumAppIntf(kmac_app_agent_pkg::NUM_APP_INTF)
  ) dut (
    .clk_i              (clk            ),
    .rst_ni             (rst_n          ),
  ...
  for (genvar i = 0; i < kmac_app_agent_pkg::NUM_APP_INTF; i++) begin : gen_kmac_app_intf
