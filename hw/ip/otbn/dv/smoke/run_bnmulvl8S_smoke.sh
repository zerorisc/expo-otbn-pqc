...
$OTBN_UTIL/otbn_as.py -o $SMOKE_BIN_DIR/bnmulvl8S_smoke_test.o $SMOKE_SRC_DIR/bnmulvl8S_smoke_test.s || \
    fail "Failed to assemble bnmulvl8S_smoke_test.s"
$OTBN_UTIL/otbn_ld.py -o $SMOKE_BIN_DIR/bnmulvl8S_smoke.elf $SMOKE_BIN_DIR/bnmulvl8S_smoke_test.o || \
    fail "Failed to link bnmulvl8S_smoke_test.o"
...
timeout 5s \
  ...
  --load-elf=$SMOKE_BIN_DIR/bnmulvl8S_smoke.elf -t | tee $RUN_LOG
