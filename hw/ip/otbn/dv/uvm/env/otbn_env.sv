...
class otbn_env extends cip_base_env #(
  ...
  function void build_phase(uvm_phase phase);
    ...
    if (!uvm_config_db#(sram_ctrl_bkdr_util)::get(this, "", "imem_util", cfg.imem_util)) begin
      `uvm_fatal(`gfn, "failed to get imem_util from uvm_config_db")
    end
    if (!uvm_config_db#(sram_ctrl_bkdr_util)::get(this, "", "dmem_util", cfg.dmem_util)) begin
