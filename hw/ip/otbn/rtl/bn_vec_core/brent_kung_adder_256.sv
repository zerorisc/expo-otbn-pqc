...
module brent_kung_adder_256 (
    ...
    generate
        for (i = 0; i < 256; i++) begin
            if (i >= 31 && (i & 31) == 31) begin
                assign G5[i] = (mode < 2) ? (G4[i] | (P4[i] & G4[i-16])) : G4[i];
                assign P5[i] = (mode < 2) ? (P4[i] & P4[i-16])           : P4[i];
            end else begin
                assign G5[i] = G4[i];
                assign P5[i] = P4[i];
            end
    ...
    generate
        for (i = 0; i < 256; i++) begin
            if (i >= 63 && (i & 63) == 63) begin
                assign G6[i] = (mode < 1) ? (G5[i] | (P5[i] & G5[i-32])) : G5[i];
                assign P6[i] = (mode < 1) ? (P5[i] & P5[i-32])           : P5[i];
            end else begin
                assign G6[i] = G5[i];
                assign P6[i] = P5[i];
            end
    ...
    generate
        for (i = 0; i < 256; i++) begin
            if (i >= 127 && (i & 127) == 127) begin
                assign G7[i] = (mode < 1) ? (G6[i] | (P6[i] & G6[i-64])) : G6[i];
                assign P7[i] = (mode < 1) ? (P6[i] & P6[i-64])           : P6[i];
            end else begin
                assign G7[i] = G6[i];
                assign P7[i] = P6[i];
            end
    ...
    generate
        for (i = 0; i < 256; i++) begin
            if (i == 255) begin
                assign G8[i] = (mode < 1) ? (G7[i] | (P7[i] & G7[i-128])) : G7[i];
            end else begin
                assign G8[i] = G7[i];
            end
        end
    ...
    always_comb begin
        ...
        C[ 16] = (mode < 2) ? (G8[ 15] | (P7[ 15] & C[  0])) : 1'b0;
        ...
        C[ 32] = (mode < 1) ? (G8[ 31] | (P7[ 31] & C[  0])) : 1'b0;
        ...
        C[ 48] = (mode < 2) ? (G8[ 47] | (P7[ 47] & C[ 32])) : 1'b0;
        ...
        C[ 64] = (mode < 1) ? (G8[ 63] | (P7[ 63] & C[  0])) : 1'b0;
        ...
        C[ 80] = (mode < 2) ? (G8[ 79] | (P7[ 79] & C[ 64])) : 1'b0;
        ...
        C[ 96] = (mode < 1) ? (G8[ 95] | (P7[ 95] & C[ 64])) : 1'b0;
        ...
        C[112] = (mode < 2) ? (G8[111] | (P7[111] & C[ 96])) : 1'b0;
        ...
        C[128] = (mode < 1) ? (G8[127] | (P7[127] & C[  0])) : 1'b0;
        ...
        C[144] = (mode < 2) ? (G8[143] | (P7[143] & C[128])) : 1'b0;
        ...
        C[160] = (mode < 1) ? (G8[159] | (P7[159] & C[128])) : 1'b0;
        ...
        C[176] = (mode < 2) ? (G8[175] | (P7[175] & C[160])) : 1'b0;
        ...
        C[192] = (mode < 1) ? (G8[191] | (P7[191] & C[128])) : 1'b0;
        ...
        C[208] = (mode < 2) ? (G8[207] | (P7[207] & C[192])) : 1'b0;
        ...
        C[224] = (mode < 1) ? (G8[223] | (P7[223] & C[192])) : 1'b0;
        ...
        C[240] = (mode < 2) ? (G8[239] | (P7[239] & C[224])) : 1'b0;
    ...
    assign cout = (mode == 2'b00) ? C[256] : 1'b0;
