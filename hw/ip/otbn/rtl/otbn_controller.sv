...
#(
  ...
  generate
    if (OtbnPQCEn) begin : gen_kmac_nets
  ...
  generate
    if (OtbnPQCEn) begin : gen_mac_operation_pqc
  ...
  generate
    if (OtbnPQCEn) begin : gen_bignum_wr_ctrl_pqc
      always_comb begin
  ...
  generate
    if (OtbnPQCEn) begin : gen_csr_ctrl_pqc
      always_comb begin
  ...
  generate
    if (OtbnPQCEn) begin : gen_wsr_ctrl_pqc
      always_comb begin
