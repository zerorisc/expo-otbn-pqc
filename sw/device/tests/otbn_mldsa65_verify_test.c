...
// Declare symbols and addresses for otbn_mldsa65_verify_test.s
OTBN_DECLARE_APP_SYMBOLS(otbn_mldsa65_verify_test);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mldsa65_verify_test, signature);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mldsa65_verify_test, message);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mldsa65_verify_test, messagelen);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mldsa65_verify_test, pk);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mldsa65_verify_test, ctx);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mldsa65_verify_test, result);


static const otbn_app_t kAppMLDSAIsaextVerify = OTBN_APP_T_INIT(otbn_mldsa65_verify_test);
static const otbn_addr_t kSigIsaext = OTBN_ADDR_T_INIT(otbn_mldsa65_verify_test, signature);
static const otbn_addr_t kMsgIsaext = OTBN_ADDR_T_INIT(otbn_mldsa65_verify_test, message);
static const otbn_addr_t kMlenIsaext = OTBN_ADDR_T_INIT(otbn_mldsa65_verify_test, messagelen);
static const otbn_addr_t kPkIsaext = OTBN_ADDR_T_INIT(otbn_mldsa65_verify_test, pk);
static const otbn_addr_t kCtxIsaext = OTBN_ADDR_T_INIT(otbn_mldsa65_verify_test, ctx);
static const otbn_addr_t kResIsaext = OTBN_ADDR_T_INIT(otbn_mldsa65_verify_test, result);
