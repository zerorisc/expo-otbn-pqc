...
// Declare symbols and addresses for otbn_mldsa87_keypair_test.s
OTBN_DECLARE_APP_SYMBOLS(otbn_mldsa87_keypair_test);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mldsa87_keypair_test, zeta);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mldsa87_keypair_test, pk);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mldsa87_keypair_test, sk);

static const otbn_app_t kAppMLDSAIsaextKeypair = OTBN_APP_T_INIT(otbn_mldsa87_keypair_test);
static const otbn_addr_t kZetaIsaext = OTBN_ADDR_T_INIT(otbn_mldsa87_keypair_test, zeta);
static const otbn_addr_t kPkIsaext = OTBN_ADDR_T_INIT(otbn_mldsa87_keypair_test, pk);
static const otbn_addr_t kSkIsaext = OTBN_ADDR_T_INIT(otbn_mldsa87_keypair_test, sk);
