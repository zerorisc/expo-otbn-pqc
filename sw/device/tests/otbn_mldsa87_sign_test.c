...
// Declare symbols and addresses for otbn_mldsa87_sign_test.s
OTBN_DECLARE_APP_SYMBOLS(otbn_mldsa87_sign_test);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mldsa87_sign_test, signature);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mldsa87_sign_test, message);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mldsa87_sign_test, messagelen);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mldsa87_sign_test, sk);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mldsa87_sign_test, ctx);

static const otbn_app_t kAppMLDSAIsaextSign = OTBN_APP_T_INIT(otbn_mldsa87_sign_test);
static const otbn_addr_t kSigIsaext = OTBN_ADDR_T_INIT(otbn_mldsa87_sign_test, signature);
static const otbn_addr_t kMsgIsaext = OTBN_ADDR_T_INIT(otbn_mldsa87_sign_test, message);
static const otbn_addr_t kMlenIsaext = OTBN_ADDR_T_INIT(otbn_mldsa87_sign_test, messagelen);
static const otbn_addr_t kSkIsaext = OTBN_ADDR_T_INIT(otbn_mldsa87_sign_test, sk);
static const otbn_addr_t kCtxIsaext = OTBN_ADDR_T_INIT(otbn_mldsa87_sign_test, ctx);
