...
OTBN_DECLARE_APP_SYMBOLS(otbn_mlkem1024_decap_test);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mlkem1024_decap_test, ct);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mlkem1024_decap_test, dk);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mlkem1024_decap_test, ss);

static const otbn_app_t kAppMLKEMIsaextDecap = OTBN_APP_T_INIT(otbn_mlkem1024_decap_test);
static const otbn_addr_t kCtDIsaext = OTBN_ADDR_T_INIT(otbn_mlkem1024_decap_test, ct);
static const otbn_addr_t kDkDIsaext = OTBN_ADDR_T_INIT(otbn_mlkem1024_decap_test, dk);
static const otbn_addr_t kSsDIsaext = OTBN_ADDR_T_INIT(otbn_mlkem1024_decap_test, ss);
