...
OTBN_DECLARE_APP_SYMBOLS(otbn_mlkem512_encap_test);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mlkem512_encap_test, coins);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mlkem512_encap_test, ct);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mlkem512_encap_test, ss);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mlkem512_encap_test, ek);

static const otbn_app_t kAppMLKEMIsaextEncap = OTBN_APP_T_INIT(otbn_mlkem512_encap_test);
static const otbn_addr_t kCoinsEIsaext = OTBN_ADDR_T_INIT(otbn_mlkem512_encap_test, coins);
static const otbn_addr_t kCtEIsaext = OTBN_ADDR_T_INIT(otbn_mlkem512_encap_test, ct);
static const otbn_addr_t kSsEIsaext = OTBN_ADDR_T_INIT(otbn_mlkem512_encap_test, ss);
static const otbn_addr_t kEkEIsaext = OTBN_ADDR_T_INIT(otbn_mlkem512_encap_test, ek);
