...
OTBN_DECLARE_APP_SYMBOLS(otbn_mlkem512_keypair_test);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mlkem512_keypair_test, coins);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mlkem512_keypair_test, dk);
OTBN_DECLARE_SYMBOL_ADDR(otbn_mlkem512_keypair_test, ek);

static const otbn_app_t kAppMLKEMIsaextKeypair = OTBN_APP_T_INIT(otbn_mlkem512_keypair_test);
static const otbn_addr_t kCoinsIsaext = OTBN_ADDR_T_INIT(otbn_mlkem512_keypair_test, coins);
static const otbn_addr_t kEkIsaext = OTBN_ADDR_T_INIT(otbn_mlkem512_keypair_test, ek);
static const otbn_addr_t kDkIsaext = OTBN_ADDR_T_INIT(otbn_mlkem512_keypair_test, dk);
