...
test_bnmulv_16H:
  ...
  /* 0 -- 1: no acc -- .lo */
  bn.mulv.16H.even.lo w2, w0, w1
  bn.sid x6, 0(x7++)

  bn.mulv.16H.odd.lo w2, w0, w1
  bn.sid x6, 0(x7++)

  /* 0 -- 2: no acc -- .hi */
  bn.mulv.16H.even.hi w2, w0, w1
  bn.sid x6, 0(x7++)

  bn.mulv.16H.odd.hi w2, w0, w1
  bn.sid x6, 0(x7++)
  ...
  /* 1 -- 1: acc -- .lo */
  bn.mulv.16H.even.acc.lo w2, w0, w1
  bn.sid x6, 0(x7++)
  bn.wsrr w3, 0x3
  bn.sid x8, 0(x7++)

  bn.mulv.16H.odd.acc.lo w2, w0, w1
  bn.sid x6, 0(x7++)
  bn.wsrr w3, 0x3
  bn.sid x8, 0(x7++)

  /* 1 -- 2: acc -- .hi */
  bn.mulv.16H.even.acc.hi w2, w0, w1
  bn.sid x6, 0(x7++)
  bn.wsrr w3, 0x3
  bn.sid x8, 0(x7++)

  bn.mulv.16H.odd.acc.hi w2, w0, w1
  bn.sid x6, 0(x7++)
  bn.wsrr w3, 0x3
  bn.sid x8, 0(x7++)
  ...
  /* 2 -- 1: acc.z -- .lo */
  bn.mulv.16H.even.acc.z.lo w2, w0, w1
  bn.sid x6, 0(x7++)
  bn.wsrr w3, 0x3
  bn.sid x8, 0(x7++)

  bn.mulv.16H.odd.acc.z.lo w2, w0, w1
  bn.sid x6, 0(x7++)
  bn.wsrr w3, 0x3
  bn.sid x8, 0(x7++)

  /* 2 -- 2: acc.z -- .hi */
  bn.mulv.16H.even.acc.z.hi w2, w0, w1
  bn.sid x6, 0(x7++)
  bn.wsrr w3, 0x3
  bn.sid x8, 0(x7++)

  bn.mulv.16H.odd.acc.z.hi w2, w0, w1
  bn.sid x6, 0(x7++)
  bn.wsrr w3, 0x3
  bn.sid x8, 0(x7++)
...
test_bnmulvl_16H:
  ...
  /* 0 -- 1: no acc -- .lo */
  bn.mulv.l.16H.even.lo w2, w0, sw1.3
  bn.sid x6, 0(x7++)

  bn.mulv.l.16H.odd.lo w2, w0, sw1.3
  bn.sid x6, 0(x7++)

  /* 0 -- 2: no acc -- .hi */
  bn.mulv.l.16H.even.hi w2, w0, sw1.3
  bn.sid x6, 0(x7++)

  bn.mulv.l.16H.odd.hi w2, w0, sw1.3
  bn.sid x6, 0(x7++)
  ...
  /* 1 -- 1: acc -- .lo */
  bn.mulv.l.16H.even.acc.lo w2, w0, sw1.3
  bn.sid x6, 0(x7++)
  bn.wsrr w3, 0x3
  bn.sid x8, 0(x7++)

  bn.mulv.l.16H.odd.acc.lo w2, w0, sw1.3
  bn.sid x6, 0(x7++)
  bn.wsrr w3, 0x3
  bn.sid x8, 0(x7++)

  /* 1 -- 2: acc -- .hi */
  bn.mulv.l.16H.even.acc.hi w2, w0, sw1.3
  bn.sid x6, 0(x7++)
  bn.wsrr w3, 0x3
  bn.sid x8, 0(x7++)

  bn.mulv.l.16H.odd.acc.hi w2, w0, sw1.3
  bn.sid x6, 0(x7++)
  bn.wsrr w3, 0x3
  bn.sid x8, 0(x7++)
  ...
  /* 2 -- 1: acc.z -- .lo */
  bn.mulv.l.16H.even.acc.z.lo w2, w0, sw1.3
  bn.sid x6, 0(x7++)
  bn.wsrr w3, 0x3
  bn.sid x8, 0(x7++)

  bn.mulv.l.16H.odd.acc.z.lo w2, w0, sw1.3
  bn.sid x6, 0(x7++)
  bn.wsrr w3, 0x3
  bn.sid x8, 0(x7++)

  /* 2 -- 2: acc.z -- .hi */
  bn.mulv.l.16H.even.acc.z.hi w2, w0, sw1.3
  bn.sid x6, 0(x7++)
  bn.wsrr w3, 0x3
  bn.sid x8, 0(x7++)

  bn.mulv.l.16H.odd.acc.z.hi w2, w0, sw1.3
  bn.sid x6, 0(x7++)
  bn.wsrr w3, 0x3
  bn.sid x8, 0(x7++)
