...
test_bnmulvl_8S:
  /* 0 -- 3: no acc - .hi.cond */
  bn.mulv.l.8S.even.hi.cond w2, w0, sw0.0
  bn.sid x6, 0(x7++)
  bn.wsrr w2, 0xb
  bn.sid x6, 0(x7++)

  bn.mulv.l.8S.odd.hi.cond w2, w0, sw0.1
  bn.sid x6, 0(x7++)
  bn.wsrr w2, 0xb
  bn.sid x6, 0(x7++)

  /* 1 -- 3: acc - .hi.cond */
  bn.mulv.l.8S.even.acc.hi.cond w2, w0, sw0.2
  bn.sid x6, 0(x7++)
  bn.wsrr w2, 0xb
  bn.sid x6, 0(x7++)

  bn.mulv.l.8S.odd.acc.hi.cond w2, w0, sw1.3
  bn.sid x6, 0(x7++)
  bn.wsrr w2, 0xb
  bn.sid x6, 0(x7++)

  /* 2 -- 3: acc.z - .hi.cond */
  bn.mulv.l.8S.even.acc.z.hi.cond w2, w0, sw1.4
  bn.sid x6, 0(x7++)
  bn.wsrr w2, 0xb
  bn.sid x6, 0(x7++)

  bn.mulv.l.8S.odd.acc.z.hi.cond w2, w0, sw1.5
  bn.sid x6, 0(x7++)
  bn.wsrr w2, 0xb
  bn.sid x6, 0(x7++)
...
test_bnmulvl_16H:
  /* 0 -- 3: no acc - .hi.cond */
  bn.mulv.l.16H.hi.cond w2, w0, sw1.0
  bn.sid x6, 0(x7++)
  bn.wsrr w2, 0xb
  bn.sid x6, 0(x7++)
  bn.wsrr w2, 0xc
  ...
  /* 1 -- 3: acc - .hi.cond */
  bn.mulv.l.16H.acc.hi.cond w2, w0, sw1.1
  bn.sid x6, 0(x7++)
  bn.wsrr w2, 0xb
  bn.sid x6, 0(x7++)
  bn.wsrr w2, 0xc
  ...
  /* 2 -- 3: acc.z - .hi.cond */
  bn.mulv.l.16H.acc.z.hi.cond w2, w0, sw1.2
  bn.sid x6, 0(x7++)
  bn.wsrr w2, 0xb
  bn.sid x6, 0(x7++)
  bn.wsrr w2, 0xc
